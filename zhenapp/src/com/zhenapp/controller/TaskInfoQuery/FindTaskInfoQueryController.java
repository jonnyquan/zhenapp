...
@Controller
public class FindTaskInfoQueryController {
	@Autowired
	...
	@RequestMapping("/api/findTaskInfoQueryuser")
	public @ResponseBody ModelAndView findTaskInfoQueryuser(HttpSession session,Integer page,String taskpk,String taskkeyword,String datefrom,String dateto,String taskid,String usernick,String taskkeynum,String tasktype) throws Exception{
		...
		mv.setViewName("/backstage/task/taskQuerylist.jsp");
		return mv;
	}
}
