...
@Controller
public class FindTaskInfoQuerybeforeagentController {
	@Autowired
	...
	@RequestMapping("/api/findTaskInfoQuerybeforeagent")
	public @ResponseBody ModelAndView findTaskInfoQuerybeforeagent(HttpSession session,Integer page,String taskpk,String taskkeyword,String datefrom,String dateto,String taskid,String usernick,String taskkeynum,String tasktype) throws Exception{
		...
		mv.setViewName("/backstage/agent/taskQuerylistbefore.jsp");
		return mv;
	}
}
