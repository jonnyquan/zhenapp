...
@Controller
public class FindTaskInfoQuerybeforeAdminController {
	@Autowired
	...
	@RequestMapping("/api/findTaskInfoQuerybefore")
	public @ResponseBody ModelAndView findTaskInfoQuerybefore(HttpSession session,Integer page,String taskpk,String taskkeyword,String datefrom,String dateto,String taskid,String usernick,String taskkeynum,String tasktype) throws Exception{
		...
		mv.setViewName("/backstage/admin/taskQuerylistbefore.jsp");
		return mv;
	}
}
