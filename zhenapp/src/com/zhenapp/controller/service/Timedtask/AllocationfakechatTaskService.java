...
@Transactional
@Service
public class AllocationfakechatTaskService {
	@Autowired
	...
	public synchronized @ResponseBody String allocateiontaskfakechat(TPhoneInfoCustom tPhoneInfoCustom,String tasknumstr) throws Exception{
