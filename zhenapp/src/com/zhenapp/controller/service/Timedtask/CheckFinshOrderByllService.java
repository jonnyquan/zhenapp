...
@Transactional
@Service
public class CheckFinshOrderByllService {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
	SimpleDateFormat yyyyMMdd = new SimpleDateFormat("yyyyMMdd");
	SimpleDateFormat yyyy_MM_dd = new SimpleDateFormat("yyyy-MM-dd");
	private static Logger logger = Logger.getLogger(CheckFinshOrderByllService.class);
	@Autowired
	 ...
	 */
	public @ResponseBody ModelMap cyclecheckTaskByll(TTaskInfoCustom tTaskInfoCustom) throws Exception{
