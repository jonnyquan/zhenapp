package com.zhenapp.controller.apitest.test;
...
import com.zhenapp.controller.apitest.TaskallocationztcService;
...
@Controller
public class TestTaskallocationztcController {
	 ...
	 * 任务分配
	 */
	@RequestMapping(value="/api/allocationztc/{pk}")
	public @ResponseBody ModelMap allocationztc(@PathVariable(value="pk")String pk) throws Exception{
