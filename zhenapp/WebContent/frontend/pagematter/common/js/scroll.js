$(function(){
	...
	'#scroll ul li a{display:block;width:50px;height:50px;line-height:50px;background:url(/img/sliderImg.png) #bababa 0 -20px no-repeat;overflow:hidden;text-indent:-999999px;color:#fff;}'+
