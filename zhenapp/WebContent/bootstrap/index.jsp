	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 tab2-img">
				<img src="${pageContext.request.contextPath}/bootstrap/img/index/tab2.png" class="auto img-responsive center-block" alt="">
			</div>
...
<div id="divQQbox" class="QQbox">
	<div id="divOnline" class="Qlist" style="background:url(${pageContext.request.contextPath}/bootstrap/img/index/${tWebInfoCustom.bg01}) no-repeat;">
		<div class="OnlineLeft">
			<div class="con">
				<ul>
					<li>售前咨询<a target="_blank" href="tencent://message/?uin=${tWebInfoCustom.qq}&amp;&amp;Site=www.zhenapp.cn&amp;&amp;Menu=yes"><img
						border="0" src="http://wpa.qq.com/pa?p=1:${tWebInfoCustom.qq}:42"></a></li>
					<li>网站建设<a target="_blank" href="tencent://message/?uin=${tWebInfoCustom.qq}&amp;&amp;Site=www.zhenapp.cn&amp;&amp;Menu=yes"><img
						border="0" src="http://wpa.qq.com/pa?p=1:${tWebInfoCustom.qq}:42"></a></li>
					<li>网站优化<a target="_blank" href="tencent://message/?uin=${tWebInfoCustom.qq}&amp;&amp;Site=www.zhenapp.cn&amp;&amp;Menu=yes"><img
						border="0" src="http://wpa.qq.com/pa?p=1:${tWebInfoCustom.qq}8:42"></a></li>
					<li>整合营销<a target="_blank" href="tencent://message/?uin=${tWebInfoCustom.qq}&amp;&amp;Site=www.zhenapp.cn&amp;&amp;Menu=yes"><img
						border="0" src="http://wpa.qq.com/pa?p=1:${tWebInfoCustom.qq}:42"></a></li>
					<li>售后服务<a target="_blank" href="tencent://message/?uin=${tWebInfoCustom.qq}&amp;&amp;Site=www.zhenapp.cn&amp;&amp;Menu=yes"><img
						border="0" src="http://wpa.qq.com/pa?p=1:${tWebInfoCustom.qq}:42"></a></li>
				</ul>
			</div>
		</div>
		<div class="OnlineBtn" style="background:url(${pageContext.request.contextPath}/bootstrap/img/index/${tWebInfoCustom.bg02}) no-repeat;">
		</div>
	</div>
</div>
