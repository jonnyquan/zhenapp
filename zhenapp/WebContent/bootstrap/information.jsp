...
<body>
	...
	<div class="container" style="height:85px;">
		<div class="navbar-header">
			<a href="index.html" class="navbar-brand logo"><img
				src="${pageContext.request.contextPath}/bootstrap/img/index/logo.png"
				alt="瓢城企训网"></a>
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a
					href="${pageContext.request.contextPath}/index/findwebinfo"
					style="height:85px;line-height:80px;font-size:20px;"><span
						class="glyphicon glyphicon-home"></span> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/electrity/findElectrity_10"
					style="height:85px;line-height:80px;font-size:20px;color: #FFA8A8;"><span
						class="glyphicon glyphicon-list"></span> 电商干货</a></li>
				<li><a
					href="${pageContext.request.contextPath}/guide/findGuide_10"
					style="height:85px;line-height:80px;font-size:20px;"><span
						class="glyphicon glyphicon-fire"></span> 新手指引</a></li>
				<li><a
	...
	<div style="height:100px;background-color: #EEE"></div>
		...
		<div class="container">
			<div class="col-md-4 info-right hidden-xs hidden-sm">
				...
				<div class="row">
							...
							<table id="table">
								<c:forEach items="${TelectricityCustomlist}" var="item">
									<tr>
										...
										<td style="margin:5px; padding:5px;border: 1px dashed #fff;">
											<a
											href="${pageContext.request.contextPath}/electrity/details/${item.electricitypk}"><font
												color="#666" size="3">${item.electricityname}</font></a>
										</td>
									</tr>
								</c:forEach>
							</table>
					...
					<div class="col-md-12 col-sm-12 col-xs-12"
						style="background-color: #fff;height:20px;width:300px;"></div>
					<div class="col-md-12 col-sm-12 col-xs-12"
						style="background-color: #fff;">
						<blockquote>
							<h4>新手注意事项</h4>
							...
							<table id="table2">
								<c:forEach items="${TGuideInfoCustomlist}" var="item">
									<tr>
										...
										<td style="margin:5px; padding:5px;border: 1px dashed #fff;">
											<a
											href="${pageContext.request.contextPath}/guide/details/${item.guidepk}"><font
												color="#666" size="3">${item.guidename}</font></a>
										</td>
									</tr>
								</c:forEach>
							</table>
			...
			<div class="col-md-7 ">
				<div>
					<blockquote
						style="margin:5px; padding:5px;border: 1px dashed #eee;">
						<h3>电商信息</h3>
					</blockquote>
					<div style="height:700px;">
						<table id="table3" width="100%">
							<c:forEach items="${TelectricityCustomAlllist}" var="item"
								varStatus="status">
								<tr>
									<td
										style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;">
										<span class="glyphicon glyphicon-menu-right"></span>
									</td>
									<td
										style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;">
										<a id="linka" onmouseout="this.style.color='#777'"
										onmousemove="this.style.color='red'"
										href="${pageContext.request.contextPath}/electrity/details/${item.electricitypk}">
											<font size="2">${item.electricityname}</font>
									</a>
									</td>
									<td
										style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;">
									...
									<td
										style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;"
										align="right"><font size="2">${item.createtime}</font></td>
								</tr>
