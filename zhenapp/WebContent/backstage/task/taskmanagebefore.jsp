	...
	<div class="rightbox row_r">
		<div class="u_outbox">
			<div class="tabtitle clearfix">
				<a href="${pageContext.request.contextPath}/task/responsetaskmanage" class="row_l ">流量任务管理</a>
				<a href="${pageContext.request.contextPath}/task/responsetaskmanagebefore" class="row_l hover">历史任务管理</a>
				<a href="${pageContext.request.contextPath}/user/responseuser" class="row_l back">返回个人中心</a>
			</div>
			<div class="umainbox">
				<!--main-->
				<form id="searchform" class="koo_fromBox" action="${pageContext.request.contextPath}/task/responsetaskmanagebefore" method="post">
				 ...
				 $.ajax({
						...
						success : function (data, response, status) {
							if (data!=null && data.data=="success") {
								alert("删除任务成功！");
								window.location.href="${pageContext.request.contextPath}/task/responsetaskmanagebefore";
