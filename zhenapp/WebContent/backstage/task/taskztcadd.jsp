							...
							<form class="koo_fromBox" >
								...
								<table class="table">
									...
									<tr>
										...
										<td>
											<input type="text" name="tasktitle" id="tasktitle" class='form-control' placeholder="请输入宝贝标题" value="2016夏季新款亚麻女装"/>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" name="taskwirelesstitle" id="taskwirelesstitle" class='form-control' placeholder="请输入无线端标题" value="2016夏季新款亚麻女装"/>
										</td>
									</tr>
								</table>
