	...
	<div class="rightbox row_r">
		<div class="u_outbox">
			<div class="tabtitle clearfix">
				<a href="${pageContext.request.contextPath}/api/findTaskInfoQueryuser" class="row_l hover">流量任务管理</a>
				<a href="${pageContext.request.contextPath}/api/findTaskInfoQuerybeforeuser" class="row_l ">历史任务管理</a>
				<a href="${pageContext.request.contextPath}/user/responseuser" class="row_l back">返回个人中心</a>
			</div>
			<div class="umainbox">
				<!--main-->
				<form id="searchform" class="koo_fromBox" action="${pageContext.request.contextPath}/api/findTaskInfoQueryuser" method="post">
				...
				<div class="tablebox">
					<table class="table">
						...
						<c:if test="${tTaskInfoQueryCustomList == null}">
							<tr>
								<td colspan="18">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/backstage/pagematter/common/js/WdatePicker.js "></script>
				 ...
				 $.ajax({
						...
						success : function (data, response, status) {
							if (data!=null && data.data=="success") {
								alert("删除任务成功！");
								window.location.href="${pageContext.request.contextPath}/api/findTaskInfoQueryuser";
