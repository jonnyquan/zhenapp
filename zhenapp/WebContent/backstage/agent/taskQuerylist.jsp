...
function endtask(taskid,obj){
	...
	$.ajax({
		...
		success : function (data, response, status) {
			if (data!=null && data.data=="success") {
				alert("终止任务成功！");
				window.location.href="${pageContext.request.contextPath}/api/findTaskInfoQueryagent";
			} else{
				alert("终止任务失败,请联系客服！");
			}
		}
  ...
  function btn_search(num){
      ...
      window.location.href = "${pageContext.request.contextPath}/api/findTaskInfoQueryagent?page=" + num + "&datefrom=" + datefrom + "&dateto=" + dateto + "&taskpk=" + taskpk
