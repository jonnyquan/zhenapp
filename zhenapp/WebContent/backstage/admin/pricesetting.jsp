    ...
    <input type="hidden" value="${tPriceAgentInfoCustom.agentid }" name="agentid">
	 ...
	 <div class="am-form-group">
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-4">
          <input type="text" name="pricecounts5" placeholder="购物车单价" value="${tPriceAgentInfoCustom.pricecounts5 }">
        </div>
        <div class="am-u-sm-2" style="padding: 0px;">积分/个</div>
      </div>
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-4">
          <input type="text" name="pricecounts6" placeholder="收藏单价" value="${tPriceAgentInfoCustom.pricecounts6 }">
        </div>
        <div class="am-u-sm-2" style="padding: 0px;">积分/个</div>
      </div>
