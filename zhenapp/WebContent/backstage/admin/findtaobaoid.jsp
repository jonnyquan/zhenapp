...
<div class="admin-content">
	...
	<div class="am-u-sm-12 am-u-md-3" >
		<input type="text" id="pid" class="am-form-field" value=""
			placeholder="手机号">
	</div>
	...
	<div class="am-u-sm-12 am-u-md-3">
		<div class="am-form-group am-form-select">
			<select  name="problem" id="problem" class="am-form-field">
				...
				<option value="60" >未测试</option>
				<option value="61" >可用</option>
				<option value="62" >不可用</option>
				<option value="63" >购物车满</option>
				<option value="64" >未被分配，剩余的</option>
			</select>
		</div>
	</div>
	...
	<div class="am-u-sm-12 am-u-md-2">
		<a class="am-btn am-btn-default" id="reset" href="/admin/taskAccount/reset">重置</a>
	</div>
  <div class="am-u-sm-12 am-u-md-2">
