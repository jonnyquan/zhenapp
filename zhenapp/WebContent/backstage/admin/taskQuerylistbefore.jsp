...
<div class="admin-content">
  ...
  <table>
  	<tr>
  		<td style="width:30px;">
  			<a class="am-btn am-btn-secondary" href="${pageContext.request.contextPath}/api/findTaskInfoQuery">当前订单查询</a>
  		</td>
  		<td style="width:10px;">
  		</td>
  		<td style="width:30px;">
  			<a class="am-btn am-btn-secondary" href="${pageContext.request.contextPath}/api/findTaskInfoQuerybefore">历史订单查询</a>
  		</td>
  	</tr>
  </table>
  <form id="searchform" class="koo_fromBox" action="${pageContext.request.contextPath}/api/findTaskInfoQuery" method="post">
...
function endtask(taskid,obj){
	...
	$.ajax({
		...
		success : function (data, response, status) {
			if (data!=null && data.data=="success") {
				alert("终止任务成功！");
				window.location.href="${pageContext.request.contextPath}/api/findTaskInfoQuerybefore";
			} else{
				alert("终止任务失败,请联系客服！");
			}
		}
  ...
  function btn_search(num){
      ...
      window.location.href = "${pageContext.request.contextPath}/api/findTaskInfoQuerybefore?page=" + num + "&datefrom=" + datefrom + "&dateto=" + dateto + "&taskpk=" + taskpk
