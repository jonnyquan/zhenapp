...
<ul class="am-list admin-sidebar-list">
  <!--  <li><a href="/admin"><span class="am-icon-home"></span> 首页</a></li>-->
	...
	<li><a href="${pageContext.request.contextPath}/api/findTaskInfoQuery"><span class="am-icon-bar-chart"></span>订单查询</a></li>
	...
	<li><a href="${pageContext.request.contextPath}/datacount/responsedatacountsumadmin"><span class="am-icon-bar-chart"></span>数据统计2</a></li>
