	...
	<div class="container" style="height:85px;">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse" >
			<ul class="nav navbar-nav navbar-right" >
				...
				<li><a href="${pageContext.request.contextPath}/electrity/findElectrity_10" style="height:85px;line-height:80px;font-size:20px;color: #FFA8A8;"><span class="glyphicon glyphicon-list"></span> 电商干货</a></li>
				...
				<div>
					...
					<div style="height:700px;">
						<table id="table3" width="100%">
							<c:forEach items="${TelectricityCustomAlllist}" var="item" varStatus="status">
								<tr>
									...
									<td style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;">
										...
										<font size="2">${item.electricityname}</font></a>
									</td>
									<td style="margin:7px; padding:7px;border: 0px dashed #fff;  border-bottom:1px dashed #bbb;">
