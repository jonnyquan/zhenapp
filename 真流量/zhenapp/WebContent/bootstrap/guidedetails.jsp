	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 ">
				<div>
					<p>&nbsp;</p>
					<p><center><h2><font color="#CC0000">${tGuideInfoCustom.guidename}</font></h2></center></p>
					<p>&nbsp;</p>
					<p><center>发&nbsp;布 &nbsp;:&nbsp;${tGuideInfoCustom.createtime}</center></p>
					<p><hr size="1" noshade="noshade" /></p>
					<p>&nbsp;</p>
					<p>${tGuideInfoCustom.guidetext}</p>
				</div>
			</div>
		</div>
	</div>
